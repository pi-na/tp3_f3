...
\begin{figure}[H]
    ...
    \IfFileExists{esquema_rectificador_media_onda.png}{
        \includegraphics[width=0.8\textwidth]{esquema_rectificador_media_onda.png}
    }{
...
\begin{figure}[H]
    ...
    \IfFileExists{esquema_rectificador_onda_completa_puente.png}{
        \includegraphics[width=0.8\textwidth]{esquema_rectificador_onda_completa_puente.png}
    }{
...
\begin{figure}[H]
    \centering
    \IfFileExists{foto_montaje_media_onda_resistencia.jpeg}{
        \includegraphics[width=0.8\textwidth]{foto_montaje_media_onda_resistencia.jpeg}
    }{
...
\begin{figure}[H]
    \centering
    \IfFileExists{foto_montaje_onda_completa_puente.jpeg}{
        \includegraphics[width=0.8\textwidth]{foto_montaje_onda_completa_puente.jpeg}
    }{
...
\begin{figure}[H]
    \centering
    \IfFileExists{foto_montaje_onda_completa_con_capacitor.jpeg}{
        \includegraphics[width=0.8\textwidth]{foto_montaje_onda_completa_con_capacitor.jpeg}
    }{
...
\begin{figure}[H]
    \centering
    \IfFileExists{oscilograma_media_onda_resistencia_sin_C}{
        \includegraphics[width=0.8\textwidth]{oscilograma_media_onda_resistencia_sin_C}
    }{
        \fbox{Archivo \texttt{oscilograma\_media\_onda\_resistencia\_sin\_C} no encontrado}
    }
...
\begin{figure}[H]
    \centering
    \IfFileExists{oscilograma_media_onda_resistencia_C1}{
        \includegraphics[width=0.8\textwidth]{oscilograma_media_onda_resistencia_C1}
    }{
        \fbox{Archivo \texttt{oscilograma\_media\_onda\_resistencia\_C1} no encontrado}
    }
...
\begin{figure}[H]
    \centering
    \IfFileExists{oscilograma_media_onda_resistencia_C2}{
        \includegraphics[width=0.8\textwidth]{oscilograma_media_onda_resistencia_C2}
    }{
        \fbox{Archivo \texttt{oscilograma\_media\_onda\_resistencia\_C2} no encontrado}
    }
...
\begin{figure}[H]
    \centering
    \IfFileExists{oscilograma_media_onda_cooler_C1}{
        \includegraphics[width=0.8\textwidth]{oscilograma_media_onda_cooler_C1}
    }{
        \fbox{Archivo \texttt{oscilograma\_media\_onda\_cooler\_C1} no encontrado}
    }
...
\begin{figure}[H]
    \centering
    \IfFileExists{oscilograma_media_onda_cooler_C2}{
        \includegraphics[width=0.8\textwidth]{oscilograma_media_onda_cooler_C2}
    }{
        \fbox{Archivo \texttt{oscilograma\_media\_onda\_cooler\_C2} no encontrado}
    }
...
\begin{figure}[H]
    \centering
    \IfFileExists{oscilograma_media_onda_cooler_C3}{
        \includegraphics[width=0.8\textwidth]{oscilograma_media_onda_cooler_C3}
    }{
        \fbox{Archivo \texttt{oscilograma\_media\_onda\_cooler\_C3} no encontrado}
    }
...
\begin{figure}[H]
    \centering
    \IfFileExists{oscilograma_onda_completa_sin_C}{
        \includegraphics[width=0.8\textwidth]{oscilograma_onda_completa_sin_C}
    }{
        \fbox{Archivo \texttt{oscilograma\_onda\_completa\_sin\_C} no encontrado}
    }
...
\begin{figure}[H]
    \centering
    \IfFileExists{oscilograma_onda_completa_C1}{
        \includegraphics[width=0.8\textwidth]{oscilograma_onda_completa_C1}
    }{
        \fbox{Archivo \texttt{oscilograma\_onda\_completa\_C1} no encontrado}
    }
...
\begin{figure}[H]
    \centering
    \IfFileExists{oscilograma_onda_completa_C2}{
        \includegraphics[width=0.8\textwidth]{oscilograma_onda_completa_C2}
    }{
        \fbox{Archivo \texttt{oscilograma\_onda\_completa\_C2} no encontrado}
    }
...
\begin{figure}[H]
    \centering
    \IfFileExists{oscilograma_onda_completa_C3}{
        \includegraphics[width=0.8\textwidth]{oscilograma_onda_completa_C3}
    }{
        \fbox{Archivo \texttt{oscilograma\_onda\_completa\_C3} no encontrado}
    }
...
\begin{enumerate}
    ...
    \[
        V_{\text{p}} \approx \frac{V_{\text{pp,salida}}}{2} \approx \SI{8,05}{\volt}.
    \]
    ...
    \[
        V_{\text{RMS}} = \sqrt{\frac{1}{T}\int_0^{T} V_{\text{p}}^{2} \sin^{2}(\omega t)\, dt}
                      ...
                      \approx \frac{8{,}05}{\sqrt{2}} \approx \SI{5,7}{\volt}.
    \]
